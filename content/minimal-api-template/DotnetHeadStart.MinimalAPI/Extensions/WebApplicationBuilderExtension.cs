...
namespace DotnetHeadStart.MinimalAPI.Extensions;
...
public static class WebApplicationBuilderExtension
{
    ...
    /// <summary>
    /// Configure MySql database connection based on a connectionstring, or environment variables to build the connectionstring.
    /// </summary>
    /// <typeparam name="T">The DbContext class to base the database connection on.</typeparam>
